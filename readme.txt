...
= 1.0.67 =
* Добавлена справка по работе с модулем

= 1.0.73 =
исправления и улучшения

= 1.0.74 =
Добавлено сравнение габаритов терминалов с отдельным габаритами посылки
При сравнении наложенного платежа на терминале учитывается валюта терминала
исправления и улучшения

= 1.0.77 = 
Исправлена ошибка с определением района города получателя

= 1.0.77 = 
Добавлены отдельные поля для авторизации в тестовом режиме

= 1.0.80 = 
Добавлена возможность передачи артикула товара во вложении при формировании заявки DPD

= 1.0.81 = 
Добавлена поддержка опций ЧСТ и ОБР
